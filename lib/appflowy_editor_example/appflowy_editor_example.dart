...
import 'package:gtbook/appflowy_editor_example/pages/auto_complete_editor.dart';
import 'package:gtbook/appflowy_editor_example/pages/collab_editor.dart';
import 'package:gtbook/appflowy_editor_example/pages/collab_selection_editor.dart';
import 'package:gtbook/appflowy_editor_example/pages/customize_theme_for_editor.dart';
import 'package:gtbook/appflowy_editor_example/pages/editor.dart';
import 'package:gtbook/appflowy_editor_example/pages/editor_list.dart';
import 'package:gtbook/appflowy_editor_example/pages/fixed_toolbar_editor.dart';
import 'package:gtbook/appflowy_editor_example/pages/focus_example_for_editor.dart';
import 'package:gtbook/appflowy_editor_example/pages/markdown_editor.dart';
...
class AppflowyEditorExample extends StatefulWidget {
  const AppflowyEditorExample({super.key});

  @override
  State<AppflowyEditorExample> createState() => _AppflowyEditorExampleState();
}

class _AppflowyEditorExampleState extends State<AppflowyEditorExample> {
      ...
      child: ListView(
        ...
        children: [
          DrawerHeader(
            ...
            child: Image.asset(
              'assets/appflowy_editor_example/images/icon.jpeg',
              fit: BoxFit.fill,
            ),
          ),
          ...
          _buildListTile(context, 'With Example.json', () {
            final jsonString = UniversalPlatform.isDesktopOrWeb
                ? rootBundle
                    .loadString('assets/appflowy_editor_example/example.json')
                : rootBundle.loadString(
                    'assets/appflowy_editor_example/mobile_example.json');
          ...
          _buildListTile(context, 'With Example.html', () async {
            final htmlString = await rootBundle
                .loadString('assets/appflowy_editor_example/example.html');
          ...
          _buildListTile(context, 'RTL', () {
            final jsonString = rootBundle.loadString(
              'assets/appflowy_editor_example/arabic_example.json',
            );
            _loadEditor(
              context,
              jsonString,
